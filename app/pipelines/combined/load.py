...
from app.database.postgres.environment_conditions_connection import connection as postgres_connection
...
async def load_province_data(
    ...
    """Load a province into the databases that own its respective data domains."""
